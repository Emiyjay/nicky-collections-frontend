        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="md:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer" aria-label="Nicky Collections on WhatsApp"
              ...
              <a href="https://instagram.com/nickycollections" target="_blank" rel="noreferrer" aria-label="Nicky Collections on Instagram"
          ...
          <div>
            ...
            <div className="space-y-4">
              <a href={WHATSAPP_LINK} target="_blank" rel="noreferrer"
                className="flex items-center gap-3 text-sm text-brand-gray hover:text-green-400 transition-colors">
                <FaWhatsapp size={16} className="text-green-400" />
                <span>{DISPLAY_PHONE_NUMBER} — WhatsApp</span>
              </a>
              <a href={PHONE_LINK}
                className="flex items-center gap-3 text-sm text-brand-gray hover:text-brand-light transition-colors">
                <FiPhone size={15} className="text-brand-gold" />
                <span>{DISPLAY_PHONE_NUMBER} — Call</span>
              </a>
              <a href={SMS_LINK}
                className="flex items-center gap-3 text-sm text-brand-gray hover:text-brand-light transition-colors">
                <FiMessageCircle size={15} className="text-brand-gold" />
                <span>{DISPLAY_PHONE_NUMBER} — SMS</span>
              </a>
              <a href={`mailto:${CONTACT_EMAIL}`} className="flex items-center gap-3 text-sm text-brand-gray hover:text-brand-light transition-colors">
