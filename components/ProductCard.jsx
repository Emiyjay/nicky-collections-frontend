        ...
        <div className="relative overflow-hidden bg-brand-muted aspect-[3/4] img-zoom">
          ...
          <button
            ...
            className={`absolute top-3 right-3 w-9 h-9 flex items-center justify-center
              bg-brand-dark/70 backdrop-blur-sm border border-white/10
              opacity-0 group-hover:opacity-100 transition-all duration-300
              hover:border-brand-pink ${wishlisted ? 'text-brand-pink' : 'text-brand-gray'}`}
          >
          ...
          <div className="absolute bottom-0 left-0 right-0 translate-y-full group-hover:translate-y-0 transition-transform duration-400">
            <button
              onClick={handleOrder}
              className="w-full bg-green-500 hover:bg-green-400 text-white text-xs tracking-widest uppercase font-body font-semibold py-3 flex items-center justify-center gap-2 transition-colors"
            >
              <FaWhatsapp size={14} />
              Order on WhatsApp
            </button>
