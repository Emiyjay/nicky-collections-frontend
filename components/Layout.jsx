  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <div className="min-h-screen bg-brand-dark text-brand-light">
        ...
        <Toaster position="top-right" toastOptions={{ style: { background: '#111111', color: '#F5F5F0', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '0', fontFamily: 'Outfit, sans-serif', fontSize: '14px' }, success: { iconTheme: { primary: '#FF1F6D', secondary: 'white' } } }} />
      </div>
    </div>
  );
}
