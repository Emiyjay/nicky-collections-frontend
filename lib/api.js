...
export const productsAPI = {
  ...
  getRelated: (id) => api.get(`/products/${encodeURIComponent(id)}/related`),
...
export const adminAPI = {
  ...
  addVideo: (id, formData) => api.post(`/admin/products/${id}/video`, formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
