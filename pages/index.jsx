...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Nicky Collections | Fashion Drops, Footwear & Accessories</title>
        <meta name="description" content="Shop fashion-forward footwear, outerwear, accessories and collectibles from Nicky Collections. Discover featured products and new arrivals, then order directly via WhatsApp." />
        <meta property="og:title" content="Nicky Collections — Fashion Drops & New Arrivals" />
        <meta property="og:description" content="Discover fashion-forward footwear, outerwear, accessories and collectibles from Nicky Collections." />
      </Head>
      ...
      <section className="my-12 mx-6 md:mx-8 max-w-7xl lg:mx-auto bg-brand-pink relative overflow-hidden"><div className="absolute inset-0 opacity-10"><div className="absolute top-0 right-0 w-64 h-64 bg-white rounded-full translate-x-1/3 -translate-y-1/3" /><div className="absolute bottom-0 left-0 w-48 h-48 bg-white rounded-full -translate-x-1/3 translate-y-1/3" /></div><div className="relative px-10 py-16 flex flex-col md:flex-row items-center justify-between gap-8"><div><p className="font-body text-white/70 text-sm tracking-widest uppercase mb-3">Limited Time</p><h2 className="font-display text-4xl md:text-5xl font-light text-white">TikTok Weekly Drops</h2><p className="font-body text-white/80 mt-3 max-w-md">New exclusive pieces every Friday. Follow us on TikTok to never miss a drop.</p></div><a href={TIKTOK_URL} target="_blank" rel="noreferrer" className="bg-white text-brand-pink font-body font-semibold text-sm tracking-widest uppercase px-6 py-3 flex items-center gap-2 hover:bg-brand-dark hover:text-white transition-all"><FaTiktok size={14} /> Follow on TikTok</a></div></section>
